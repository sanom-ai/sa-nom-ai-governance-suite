    ...
    def create_session(self, payload: dict[str, object], requested_by: str) -> dict[str, object]:
        ...
        session = HumanAskSession(
            ...
            metadata={
                ...
                "origin_request_id": str(request_metadata.get("origin_request_id", request_metadata.get("request_id", "")) or ""),
                "request_id": str(request_metadata.get("request_id", "") or ""),
                "parent_session_id": str(request_metadata.get("parent_session_id", "") or ""),
                "origin_action_id": str(request_metadata.get("origin_action_id", "") or ""),
                "case_id": str(request_metadata.get("case_id", "") or ""),
                "case_reference": str(request_metadata.get("case_reference", "") or ""),
                "execution_plan": request_metadata.get("execution_plan", {}) if isinstance(request_metadata.get("execution_plan", {}), dict) else {},
                "task_packet": request_metadata.get("task_packet", {}) if isinstance(request_metadata.get("task_packet", {}), dict) else {},
                "human_ask_phase": "A",
