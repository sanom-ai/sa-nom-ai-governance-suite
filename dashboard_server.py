...
from access_control import AccessProfile
from api_engine import build_engine_app
from config import AppConfig
from dashboard_data import DashboardSnapshotBuilder
from deployment_profile import build_deployment_report, validate_startup_or_raise
...
class DashboardRequestHandler(SimpleHTTPRequestHandler):
    def __init__(self, *args, service: DashboardService, **kwargs):
        ...
        super().__init__(*args, directory=str(service.base_dir), **kwargs)
