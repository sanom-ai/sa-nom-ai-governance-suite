...
- enter `Role Private Studio` with your own JD or operating brief
- start from a starter JD, starter rule set, or starter hat prepared by SA-NOM when you want a faster starting point
- adapt that material into an organization-specific governed hat that matches your own workflow
- then move that governed position into the broader role-publication flow

Reference:
- [ROLE_PRIVATE_STUDIO.md](ROLE_PRIVATE_STUDIO.md)
- [PRIVATE_RULE_POSITION.md](PRIVATE_RULE_POSITION.md) for the older concept note
- [../examples/role_private_studio.example.json](../examples/role_private_studio.example.json)
