...
## Release Focus
0.7.8 is the private-first tablet productization release after 0.7.7.
...
0.7.8 matters because the founder vision is not just about having a dashboard that looks clean on a laptop.
...
After 0.7.8, SA-NOM is closer to that posture:
